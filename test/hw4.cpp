    ...
    while (selection != 'q')
    {
        ...
        switch(selection)
        {
            ...
            case 'g':
            {
                ...
                //RGBImage &kati = (RGBImage&) currentImage;
                //rgbPointer = dynamic_cast <RGBImage*>(currentImage);
                ...
                // GSCImage *convert_image = new GSCImage(1, 2);


                //GSCImage *convert_image =  new GSCImage(rgbPointer);
